...
var createNonEnumerableProperty = __webpack_require__(3);
var has = __webpack_require__(4);
...
var global = __webpack_require__(0);
var setGlobal = __webpack_require__(70);
...
var IS_NODE = __webpack_require__(19);
...
var global = __webpack_require__(0);
var getBuiltIn = __webpack_require__(8);
var NativePromise = __webpack_require__(50);
var redefine = __webpack_require__(20);
...
var hostReportErrors = __webpack_require__(91);
...
class main_WechatHelper {
  ...
  init(options) {
    ...
    if (this.inWechat()) {
      ...
      spt.onload = async () => {
        ...
        if (ret) {
          console.log(`[wechat-helper]jsapi签名结果:${stringify_default()(ret)}`);
          wx.ready(() => {
          ...
          wx.error(res => {
            console.log(`[wechat-helper]jsapi wx fail:${stringify_default()(res)}`);
  ...
  setShare(options) {
    ...
    if (this.wxApiReady) {
      console.log(`[wechat-helper]设置分享内容:${stringify_default()(options)}`);
      ...
      console.log(`[wechat-helper]设置分享内容-未加载延迟设置:${stringify_default()(options)}`);
      this.shareList.pop();
