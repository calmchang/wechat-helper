(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["WechatHelper"] = factory();
	else
		root["WechatHelper"] = factory();
})(window, function() {
...
var stringify = __webpack_require__(152);
...
var buildFullPath = __webpack_require__(145);
...
var _Object$defineProperty = __webpack_require__(131);
...
var global = __webpack_require__(0);
var getBuiltIn = __webpack_require__(12);
var NativePromise = __webpack_require__(59);
var redefine = __webpack_require__(25);
...
var hostReportErrors = __webpack_require__(114);
var newPromiseCapabilityModule = __webpack_require__(22);
var perform = __webpack_require__(27);
var InternalStateModule = __webpack_require__(23);
var isForced = __webpack_require__(51);
...
var concat = __webpack_require__(125);
...
var entryVirtual = __webpack_require__(130);
...
var concat = __webpack_require__(18);
...
function GET_DEFAULT(_x, _x2) {
  return _GET_DEFAULT.apply(this, arguments);
}

function _GET_DEFAULT() {
  _GET_DEFAULT = asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee(url, param) {
    var _context;
    ...
    return regenerator_default.a.wrap(function _callee$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            if (param) param = lib_default.a.stringify(param, {
              arrayFormat: 'indices'
            });
            _context2.next = 3;
            return axios_default()({
              method: 'get',
              url: param ? concat_default()(_context = "".concat(url, "?")).call(_context, param) : url
            });

          case 3:
            response = _context2.sent;
            return _context2.abrupt("return", response && response.data ? response.data : null);
...
function GET_DEFAULT_CROSS(_x3, _x4) {
...
function _GET_DEFAULT_CROSS() {
  _GET_DEFAULT_CROSS = asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee2(url, param) {
    var _context3;
...
function _GET_WECHAT_SIGN() {
  _GET_WECHAT_SIGN = asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee3() {
    var params,
        _args3 = arguments;
...
var main_WechatHelper = /*#__PURE__*/function () {
  ...
  createClass_default()(WechatHelper, [{
    ...
    value: function toAuth(url, needHead) {
      ...
      var wxAuth = concat_default()(_context = concat_default()(_context2 = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=".concat(appId, "&redirect_uri=")).call(_context2, redirect_uri, "&response_type=code&scope=")).call(_context, type, "&state=wxauthsuccess#wechat_redirect");

      return wxAuth;
    }
  }, {
    key: "needAuth",
    value: function needAuth(needHead) {
      var req = this.getSearch();
                ...
                case 2:
                  ...
                  if (ret) {
                    ...
                    wx.error(function (res) {
                      ...
                      if (options.fail) {
                        options.fail('微信初始化失败:' + stringify_default()(res));
                      }
                    });
                    wx.config({
                      debug: false,
                      ...
                      // 必填，签名
                      jsApiList: ['updateAppMessageShareData', 'updateTimelineShareData', 'onMenuShareAppMessage', 'onMenuShareTimeline', 'hideOptionMenu', 'hideMenuItems'] // 必填，需要使用的JS接口列表
