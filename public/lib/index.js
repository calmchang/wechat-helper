...
var IS_NODE = __webpack_require__(24);
...
var html = __webpack_require__(55);
var createElement = __webpack_require__(31);
var IS_IOS = __webpack_require__(61);
var IS_NODE = __webpack_require__(24);
...
var _Object$defineProperty = __webpack_require__(124);
...
var hostReportErrors = __webpack_require__(96);
var newPromiseCapabilityModule = __webpack_require__(20);
var perform = __webpack_require__(27);
...
var IS_IOS = __webpack_require__(61);
var IS_WEBOS_WEBKIT = __webpack_require__(95);
var IS_NODE = __webpack_require__(24);
...
var entryVirtual = __webpack_require__(113);
...
var concat = __webpack_require__(11);
...
function GET_DEFAULT(url, params) {
  return new promise_default.a(function (res, rej) {
    var _context2;
    ...
    if (params) {
      for (var key in params) {
        ...
        data.push(concat_default()(_context = "".concat(window.encodeURIComponent(key), "=")).call(_context, window.encodeURIComponent(params[key])));
      }
    ...
    url = data ? concat_default()(_context2 = "".concat(url, "?")).call(_context2, data) : url;
...
function GET_DEFAULT_CROSS(_x, _x2) {
  return _GET_DEFAULT_CROSS.apply(this, arguments);
}
/**************************************************************************
 *                  基础共享接口
 *************************************************************************/
...
function _GET_DEFAULT_CROSS() {
  _GET_DEFAULT_CROSS = asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee(url, param) {
    var _context3;
        ...
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return axios({
              ...
              url: param ? concat_default()(_context3 = "".concat(url, "?")).call(_context3, param) : url
            });

          case 3:
            response = _context4.sent;
            return _context4.abrupt("return", response && response.data ? response.data : null);
...
var HOST = 'https://m.vuedata.cn';
function GET_WECHAT_SIGN() {
  return _GET_WECHAT_SIGN.apply(this, arguments);
}

function _GET_WECHAT_SIGN() {
  _GET_WECHAT_SIGN = asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee2() {
    var params,
        _args2 = arguments;
    return regenerator_default.a.wrap(function _callee2$(_context5) {
      while (1) {
...
function GET_USER_INFO() {
  return _GET_USER_INFO.apply(this, arguments);
}

function _GET_USER_INFO() {
  _GET_USER_INFO = asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee3() {
    var params,
        _args3 = arguments;
    return regenerator_default.a.wrap(function _callee3$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            return _context6.abrupt("return", GET_DEFAULT(HOST + '/ndapp/wx/getUserInfo', params));
...
var main_WechatHelper = /*#__PURE__*/function () {
  function WechatHelper(options) {
    classCallCheck_default()(this, WechatHelper);

    var wxid = options.wxid,
        appId = options.appId,
        apis = options.apis,
        hideMenuList = options.hideMenuList,
  ...
  createClass_default()(WechatHelper, [{
    key: "init",
    value: function init(options) {
      ...
      if (this.inWechat()) {
        ...
        spt.onload = /*#__PURE__*/asyncToGenerator_default()( /*#__PURE__*/regenerator_default.a.mark(function _callee() {
          var ret;
                ...
                case 2:
                  ...
                  if (ret) {
                    ...
                    wx.error(function (res) {
                      console.log("[wechat-helper]jsapi wx fail:".concat(stringify_default()(res)));

                      if (onFail) {
                        onFail('微信初始化失败:' + stringify_default()(res));
                      }
                    });
                    wx.config({
                      debug: debug,
    ...
    key: "setShare",
    value: function setShare(options) {
      ...
      if (this.wxApiReady) {
        console.log("[wechat-helper]\u8BBE\u7F6E\u5206\u4EAB\u5185\u5BB9:".concat(stringify_default()(options)));
        ...
        console.log("[wechat-helper]\u8BBE\u7F6E\u5206\u4EAB\u5185\u5BB9-\u672A\u52A0\u8F7D\u5EF6\u8FDF\u8BBE\u7F6E:".concat(stringify_default()(options)));
        this.shareList.pop();
    ...
    key: "getSearch",
    value: function getSearch(url) {
      if (!url) url = location.href;
      var search = /([^&?#]+)=([^&?#]+)/g.execAll(url);
    ...
    value: function toRedirect() {
      ...
      console.log("[wechat-helper]toRedirect\u8DF3\u8F6C\u9875\u9762:".concat(req.redirect));
      location.replace(req.redirect);
    }
  }, {
    key: "toAuth",
    value: function toAuth(url, needHead) {
      var _context2, _context3;

      var appId = this.appId;
      var type = 'snsapi_base';

      if (needHead) {
        type = 'snsapi_userinfo';
      }

      var redirect_uri = window.encodeURIComponent(url);

      var wxAuth = concat_default()(_context2 = concat_default()(_context3 = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=".concat(appId, "&redirect_uri=")).call(_context3, redirect_uri, "&response_type=code&scope=")).call(_context2, type, "&state=wxauthsuccess#wechat_redirect");
    ...
    value: function getAuth(needHead) {
      if (this.inWechat()) {
        ...
        if (!req.code || !req.state || req.state != 'wxauthsuccess') {
          ...
          console.log("[wechat-helper]\u5DF2\u6388\u6743\uFF0Ccode:".concat(req.code));
          return {
            needAuth: false,
            code: req.code
          };
    ...
    value: function getUserInfo(code, callback) {
      ...
      return new promise_default.a( /*#__PURE__*/function () {
